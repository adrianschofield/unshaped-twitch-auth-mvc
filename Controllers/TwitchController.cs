...
namespace twitch_auth_mvc.Controllers
{
    public class TwitchController : Controller
    {
        ...
        public IActionResult Callback(string code)
        {
            ...
            twitchRedirectUri = _configuration.GetValue<string>("Apps:CallbackURI");
            twitchClientSecret = _configuration.GetValue<string>("Apps:ClientSecret");
            twitchClientId = _configuration.GetValue<string>("Apps:ClientId");
